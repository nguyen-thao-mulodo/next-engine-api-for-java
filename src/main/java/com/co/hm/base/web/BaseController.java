 ...
 * Define common variable and common method for controller
 * <p>
 * - getCurrentToken: Get current token of user logged in <br>
 * - neLogin: Request login next engine to get access token and refresh token  <br>
 * - NeApiExecute: Get response with type HashMap from api <br>
 * - neApiExecuteAndSaveToken: Get response with type HashMap from api and update new token <br>
 * - saveTokenToSession: Update token to session <br>
 * - saveToken: Update token to session and update token to database <br>
 * - GetMessage: Get message from resources/messages_us.properties <br>
 * - fetchCompanyInfo: get Company information from Ne API  <br>
 * - fetchUserInfo: get user information from Ne API  <br>
 * </p>
 */
public abstract class BaseController<U extends BaseUser,
        RU extends BaseUserRepository<U>,
        C extends BaseCompany,
        RC extends BaseCompanyRepository<C>> {
  /**
  ...
  @Autowired
  public RC companyRepository;

  @Autowired
  public RU userRepository;

  protected Class<U> userClass = null;
  protected Class<C> companyClass = null;

  public BaseController(Class<U> userClass, Class<C> companyClass) {
